...
export function incrementCustomProperty(element, property, incrementValue) {
  setCustomProperty(element, property, getCustomProperty(element, property) + incrementValue);
};